/**
 * Episode03 逐字稿 - 基于 book1-第二章-国际银行家和美国总统的百年战争
 *
 * 场景规划（9个场景）：
 * - Scene 0: 林肯的警告
...
export const episode03Transcript: TranscriptSegment[] = [
  // ===== Scene 0: 林肯的警告 =====
  {
    id: "0-1",
    scene: 0,
...
export default episode03Transcript;
